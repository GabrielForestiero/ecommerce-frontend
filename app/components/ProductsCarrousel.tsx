    ...
    <section id="productos" className="relative py-16 md:py-24 overflow-hidden bg-white">
      ...
      <div className="px-4 md:px-6 max-w-7xl mx-auto mb-12 md:mb-16">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Badge "Todos los productos" con diseño angular */}
      ...
      <div className="px-4 md:px-6 max-w-7xl mx-auto relative">
        {/* Navegación desktop - Centradas en el carrusel */}
        {canScrollPrev && (
          <button
            onClick={scrollPrev}
