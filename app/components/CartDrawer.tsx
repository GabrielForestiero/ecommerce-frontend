...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full w-full sm:w-[500px] bg-zinc-950 border-l border-zinc-800 z-50 flex flex-col animate-in slide-in-from-right duration-300">
        {/* Header */}
        <div className="flex items-center justify-between p-8 border-b border-zinc-800">
          <div>
            <h2 className="text-2xl font-bold bg-gradient-to-r from-white to-zinc-400 text-transparent bg-clip-text">
              Carrito
            </h2>
            ...
            items.map((item) => (
              ...
              >
                <div className="flex gap-5">
                  {/* Imagen */}
                  <div className="flex-shrink-0 w-24 h-24 bg-zinc-900 rounded-lg p-2 flex items-center justify-center border border-zinc-800">
                    <img
                      src={item.imageURL}
                      alt={item.name}
          ...
          <div className="border-t border-zinc-800 p-8 space-y-5">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full px-6 py-4 rounded-xl font-bold text-base bg-gradient-to-r from-cyan-500 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500 transition-all duration-200 flex items-center justify-center gap-2"
              >
